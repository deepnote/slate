...
var Editable$1 = function Editable(props) {
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (selection && selection.multiBlock && selection.anchor && selection.focus && selection.anchor.path[0] === selection.focus.path[0] && selection.anchor.path[1] === selection.focus.path[1]) {
  ...
  var onDOMSelectionChange = React.useCallback(throttle__default['default'](function () {
    if (!ReactEditor.isComposing(editor) && !state.isUpdatingSelection && !state.isDraggingInternally) {
      ...
      var anchorNode = domSelection.anchorNode,
          focusNode = domSelection.focusNode; // The DOM selection and the activeElement can be briefly inconsistent (wtf).
